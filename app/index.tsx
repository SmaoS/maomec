...
const cards = [
  {
    ...
    description: "Cálculos de engranajes, módulos y divisiones.",
  ...
  },
  {
    ...
    description: "Calcula inclinaciones y ángulos de conos.",
  ...
  },
  {
    ...
    description: "Distribución y distancia entre perforaciones.",
  ...
  },
  {
    key: "converter",
    title: "Conversor",
    description: "Milímetros, pulgadas, milésimas y fracciones.",
  ...
  return (
    <Screen>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <SectionHeader title="MaoMec" subtitle="Cálculos de taller" />
          <View style={{ flexDirection: "row", gap: 18 }}>
            ...
            <Pressable accessibilityLabel="Cambiar tema" onPress={toggleTheme}>
              <Ionicons
