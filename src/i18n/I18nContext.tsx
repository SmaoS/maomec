...
const dictionary = {
  es: {
    ...
    crankAndPlate: "Manivela y plato",
    byAngles: "Por ángulos",
    startAngle: "Ángulo inicial (opcional)",
    angularStep: "Incremento angular",
    machiningPositions: "Posiciones de mecanizado",
    position: "Posición",
    module: "Módulo",
  ...
  en: {
    ...
    crankAndPlate: "Crank and plate",
    byAngles: "By angles",
    startAngle: "Starting angle (optional)",
    angularStep: "Angular increment",
    machiningPositions: "Machining positions",
    position: "Position",
    module: "Module",
